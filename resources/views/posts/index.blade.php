@extends('layouts.app')
    @section('content')
            <div class="card">
                <h2 class="card-header mb-1  text-center">Post By All Users  </h2>
                @if(count($posts) > 0)
                    @foreach ($posts as $post)
                        ...
                        <div class="card-body ">
                                <div class="row">
                                        <div class="col-md-6 col-sm-4">
                                                <img style="width:100%" src="{{asset('storage/cover_image/'.$post->cover_image)}}" alt="Image">
                                        </div>
                        ...
                        <div>
                                ...
                                <div style="float:right" class="mx-4">
                                    ...
                                    @else
                                        <form style="float:right" action="{{route('posts.likes', $post->id)}}" method="post"  class="mb-4">
                                            @csrf
                                            @method("DELETE")
